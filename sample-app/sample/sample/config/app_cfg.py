# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in sample.
...
from sample.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = sample
...
base_config.sa_auth.cookie_secret = "5002f604-6b0e-4f92-8bc3-411eb44bde10"
